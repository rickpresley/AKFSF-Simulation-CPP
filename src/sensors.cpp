...
// Radar Sensor
RadarSensor::RadarSensor():m_rand_gen(std::mt19937()),m_range_noise_std(0.0),m_theta_noise_std(0.0){}
void RadarSensor::reset(){m_rand_gen = std::mt19937();}
void RadarSensor::setRadarNoiseStd(double range_std, double theta_std){m_range_noise_std = range_std;m_theta_noise_std = theta_std;}

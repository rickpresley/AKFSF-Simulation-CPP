...
void KalmanFilter::predictionStep(double dt)
{
    ...
    {
        // Implement the State Vector and Covariance Matrix Initialisation in
        // the section below if you want to initialise the filter WITHOUT
        // waiting for the first measurement to occur. Make sure you call the
        // setState() / setCovariance() functions once you have generated the
        // initial conditions.
        ...
        // Assume the initial velocity is 5 m/s at 45 degrees
        //      (VX,VY) = (5*cos(45deg),5*sin(45deg)) m/s
        state << 0,                 // X
                 0,                 // Y
                 5.0*cos(M_PI/4),   // VX
                 5.0*sin(M_PI/4);   // VY
...
void KalmanFilter::handleGPSMeasurement(GPSMeasurement meas)
{
    if(isInitialised())
    {
        ...
        // Implement The Kalman Filter Update Step for the GPS Measurements in
        // the section below.
        // Hint: Assume that the GPS sensor has a 3m (1 sigma) position
        //       uncertainty.
    ...
    {
        // Implement the State Vector and Covariance Matrix Initialisation in
        // the section below. Make sure you call the setState/setCovariance
        // functions once you have generated the initial conditions.
        // Hint: Assume the state vector has the form [X,Y,VX,VY].
